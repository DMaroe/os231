...
4.| this helped me to learn more about operating systems, also showed the large picture of operating systems | it's a 13 minute video that explained about operating systems in computer science | https://www.youtube.com/watch?v=26QPDBe-NB8
5.| I can practice regex puzzles while learning how to use Regex | it's basically a regex practice website where people can study more about regex | https://alf.nu/RegexGolf
6.| it helped me throughout learning how to use the text editor VI but in an improved version (VIM) | it's a website with an interactive guide on VIM | https://www.openvim.com/
7.| it helped me understand more about multiprogramming vs multiprocessing vs multitasking vs multithreading | it's an article about the differences of multiprogramming, multiprocessing, multitasking, and multithreading.| https://www.javatpoint.com/multiprogramming-vs-multiprocessing-vs-multitasking-vs-multithreading
8.| It helped me throughout learning the process controls, file management, device management, information maintenance, and communication | it's a system call types and examples article in Operating Systems. | https://www.guru99.com/system-call-operating-system.html
9.| it helped me to know more about linux | it's the history of Linux! (including BSD, Posix, and UNIX) | https://www.youtube.com/watch?v=qFTIc5frqw8&list=PLU_Er81tl-Vka_GPCCakU6NLuyVh5QICp
10.| Cloud Computing has been an interesting for me in these past few months, watching and reading it helped me understand more about it. | it's a video and article about virtualization in cloud computing | https://www.redswitches.com/blog/different-types-virtualization-cloud-computing-explained/
...
4.| it shocked me that computers are good at multiplying mathematical questions but sucked at factorizing numbers. RSA encryption was founded in the 1970s, knowing I still don't understand how to do it intrigues me even more| it's a mathematical video which involves RSA encryption algorithm. | https://www.youtube.com/watch?v=wXB-V_Keiu8
5.| Hacking has been an intriguing matter for me to learn, this video helped me through understanding some hacking phenomenons that happened in the past | This video shows about the hacker crackdown. The hacker crackdown was a 18 month long collaborative effort of the US Secret Service to take control of the internet in the early 1990s.| https://www.youtube.com/watch?v=YFwTabn9_S0
6.| ahh yes, gpg tutorials are very very useful through this week, and this article helped me a lot |  a straightforward gpg tutorial (with interactiveness and documentations) | https://www.devdungeon.com/content/gpg-tutorial
7.| I'm fond of kak Hocky's (upperclassmen from Fasilkom UI) documentations regarding this topic, it helped me to learn more about ssh tunneling. | it's a video about ssh tunneling | https://www.youtube.com/watch?v=AtuAdk4MwWw
8.| cryptocurrency has been one of the most googled topics back in 2020, 2021, and 2022. This video showed me relations regarding this course to bitcoin. | it's a video showing on how bitcoins actually work made by the youtube channel computerphile. |https://www.youtube.com/watch?v=bBC-nXj3Ng4
9.| the storyline intrigues me a lot because of the main character's behaviours, how he codes c, and how he accesses linux in the movie scenes. | it's a imaginative reality drama series about a 'hacker' named elliot. | MR. ROBOT series on netflix
10.| it intrigues me because we are using it in our very days (bashing script.sh). | it's an article about how linux file permissions work | https://www.howtogeek.com/67987/htg-explains-how-do-linux-file-permissions-work/
